...
본격적으로 알고리즘을 설명하기 전에 간단한 순서와 내용을 설명드리려고합니다.
...
하지만 저는 Ring을 적용해주면서 이 뒤죽박죽의 Data를 올바르게 오름차순으로 정렬해줄 수 있게 -15°에 0번, -13°에 1번, -11에 3번 이런식으로 정해주었습니다.
