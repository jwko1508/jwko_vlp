...
"""autogenerated by genpy from pharos_vlp_tilt/state.msg. Do not edit."""
import sys
...
class state(genpy.Message):
  _md5sum = "4dde323cb233595cceb5a9451b77b1b4"
  _type = "pharos_vlp_tilt/state"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """int32 is_ground
int32 is_del
int32 is_infect
"""
  __slots__ = ['is_ground','is_del','is_infect']
