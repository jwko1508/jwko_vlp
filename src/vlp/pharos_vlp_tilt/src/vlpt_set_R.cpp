...
public:
    ...
    VLP16_()
    {
        ...
        /// *Left
        pnh->param<float>("/pharos_tf_broadcaster_node/R_velodyne_roll",L_Xd, -15.0);
        pnh->param<float>("/pharos_tf_broadcaster_node/R_velodyne_pitch",L_Yd, 0);
        pnh->param<float>("/pharos_tf_broadcaster_node/R_velodyne_yaw",L_Zd, 0.0);

        pnh->param<double>("R_PLUS_X",L_PX, 0);
        pnh->param<double>("R_MINUS_X",L_MX, 0);
        pnh->param<double>("R_PLUS_Y",L_PY, 0);
        pnh->param<double>("R_MINUS_Y",L_MY, 0);
        pnh->param<double>("R_PLUS_Z",L_PZ, 0);
        pnh->param<double>("R_MINUS_X",L_MZ, 0);
        pnh->param<double>("R_MOVE_Y",L_MOVE_Y, 0);
...
//        std::cout << "CAR_HEIGHT_R = "<< CAR_HEIGHT << std::endl;
//        std::cout << "R_Yd_R = "<< L_Yd_L << std::endl;
...
//        }
        ...
        if(isTimeRight == true)
        {
            ROS_INFO("set_R time : %lf", diff_value);
        }
