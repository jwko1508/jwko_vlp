...
public:
    ...
    vlp_()
    {
        ...
        n->param<bool>("isTimeTop",isTimeTop, false);
...
//        pub_least_full_test.publish(*test_least_full_sensor);
        ...
        if(isTimeTop == true)
        {
            ROS_INFO("remove_T time : %lf", diff_value);
        }
}
...
{
    ros::init(argc, argv, "vlpt_remove_ground_T");

    ROS_INFO("started vlpt_remove_ground_T");
